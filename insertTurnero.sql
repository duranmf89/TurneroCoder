...
VALUES (
    1, -- ID del usuario (debe existir en la tabla Usuarios)
    1, -- ID de la cancha (debe existir en la tabla Canchas)
    '2024-04-01', -- Fecha de la reserva
    NULL, -- Hora de semana
    '12:00:00', -- Hora de fin de semana
    1, -- ID del estado de la reserva (debe existir en la tabla Estados_Reservas)
    1, -- ID del usuario reservante (debe existir en la tabla Usuarios)
    NULL, -- ID del usuario aceptante (aún no aceptado)
...
INSERT INTO Reservas (id_usuario, id_cancha, fecha, hora_semana, hora_fin_semana, id_estado, id_usuario_reservante, id_usuario_aceptante, dia_semana)
VALUES (
    2, -- ID del usuario (debe existir en la tabla Usuarios)
    2, -- ID de la cancha (debe existir en la tabla Canchas)
    '2024-04-02', -- Fecha de la reserva
    '14:00:00', -- Hora de semana
    NULL, -- Hora de fin de semana
    1, -- ID del estado de la reserva (debe existir en la tabla Estados_Reservas)
    2, -- ID del usuario reservante (debe existir en la tabla Usuarios)
    NULL, -- ID del usuario aceptante (aún no aceptado)
...
INSERT INTO Reservas (id_usuario, id_cancha, fecha, hora_semana, hora_fin_semana, id_estado, id_usuario_reservante, id_usuario_aceptante, dia_semana)
VALUES (
    3, -- ID del usuario (debe existir en la tabla Usuarios)
    3, -- ID de la cancha (debe existir en la tabla Canchas)
    '2024-04-03', -- Fecha de la reserva
    NULL, -- Hora de semana
    '18:00:00', -- Hora de fin de semana
    1, -- ID del estado de la reserva (debe existir en la tabla Estados_Reservas)
    3, -- ID del usuario reservante (debe existir en la tabla Usuarios)
    NULL, -- ID del usuario aceptante (aún no aceptado)
...
-- Tabla intermedia Usuarios_Equipos
