...
-- Modificamos el valor de fecha en Notificaciones
ALTER TABLE Notificaciones MODIFY COLUMN fecha TIMESTAMP;

-- Tabla intermedia a implementar para que muchos equipos puedan asociarse a muchos eventos (sujeta a revision)
